...
public class HolidayClientImpl implements HolidayClient {
  ...
  @Value("${app.api.holiday.path.holiday-list}")
  private String holidayListPath;

  private final WebClient webClient;

  public HolidayClientImpl(
  ...
  public Flux<HolidayDto> getHolidayList(int year, int month) {
    return webClient
        ...
        .uri(
            uriBuilder ->
                UriComponentsBuilder.fromUri(uriBuilder.path(holidayListPath).build())
        ...
        .onStatus(
            ...
            clientResponse ->
                Mono.error(
                    new WebClientFailException(clientResponse.statusCode(), holidayListPath)))
